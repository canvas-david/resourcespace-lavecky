...
--   Tab 2: "2. Transcription" - Readable content (text fields only, full-width display)
--   Tab 3: "3. Review" - Status and notes for reviewers
--   Tab 4: "4. Technical" - Processing metadata (including source language)
--   Tab 5: "5. Archival" - Raw OCR output
...
INSERT IGNORE INTO tab (ref, name, order_by) VALUES (2, '2. Transcription', 20);
INSERT IGNORE INTO tab (ref, name, order_by) VALUES (3, '3. Review', 30);
INSERT IGNORE INTO tab (ref, name, order_by) VALUES (4, '4. Technical', 40);
INSERT IGNORE INTO tab (ref, name, order_by) VALUES (5, '5. Archival', 50);

UPDATE tab SET name = '2. Transcription' WHERE ref = 2;
UPDATE tab SET name = '3. Review' WHERE ref = 3;
UPDATE tab SET name = '4. Technical' WHERE ref = 4;
UPDATE tab SET name = '5. Archival' WHERE ref = 5;
...
-- =============================================================================
-- TAB 2: "2. Transcription" (Readable content for end users - text fields only)
...
-- =============================================================================
-- TAB 3: "3. Review" (Status and notes for reviewers/editors)
-- =============================================================================
...
-- =============================================================================
-- TAB 4: "4. Technical" (Processing metadata + source language)
-- =============================================================================
...
-- =============================================================================
-- TAB 5: "5. Archival" (Raw OCR - immutable source)
-- =============================================================================
