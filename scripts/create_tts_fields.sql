...
DELETE FROM resource_type_field WHERE ref IN (101, 102, 103, 104);

-- Delete any orphaned data for these fields
DELETE FROM resource_data WHERE resource_type_field IN (101, 102, 103, 104);

-- Create TTS Status - Field 101
...
VALUES (101, 'ttsstatus', 'TTS Status', 0, 930, 1, 0, 1, 1, '', 'Transcription', '', '', 1, 0, 'TTS generation status: pending, done, failed', 0, '', '', 0, 0, 0, '', 1, '', '', 0, 1, 0);

-- Create TTS Engine - Field 102
-- Values: elevenlabs
INSERT INTO resource_type_field (ref, name, title, type, order_by, keywords_index, resource_type, display_field, enable_advanced_search, display_template, tab_name, smart_theme_name, exiftool_field, advanced_search, simple_search, help_text, display_as_dropdown, tooltip_text, regexp_filter, hide_when_uploading, hide_when_restricted, required, linked_data_field, automatic_nodes_ordering, display_condition, onchange_macro, field_constraint, active, sync_field)
VALUES (102, 'ttsengine', 'TTS Engine', 0, 940, 1, 0, 1, 1, '', 'Transcription', '', '', 1, 0, 'Text-to-speech engine used (e.g., elevenlabs)', 0, '', '', 0, 0, 0, '', 1, '', '', 0, 1, 0);

-- Create TTS Voice - Field 103
-- Values: voice name/ID used for generation
INSERT INTO resource_type_field (ref, name, title, type, order_by, keywords_index, resource_type, display_field, enable_advanced_search, display_template, tab_name, smart_theme_name, exiftool_field, advanced_search, simple_search, help_text, display_as_dropdown, tooltip_text, regexp_filter, hide_when_uploading, hide_when_restricted, required, linked_data_field, automatic_nodes_ordering, display_condition, onchange_macro, field_constraint, active, sync_field)
VALUES (103, 'ttsvoice', 'TTS Voice', 0, 950, 1, 0, 1, 1, '', 'Transcription', '', '', 1, 0, 'Voice name or ID used for TTS generation', 0, '', '', 0, 0, 0, '', 1, '', '', 0, 1, 0);

-- Create TTS Generated At - Field 104
-- Values: timestamp of last generation
INSERT INTO resource_type_field (ref, name, title, type, order_by, keywords_index, resource_type, display_field, enable_advanced_search, display_template, tab_name, smart_theme_name, exiftool_field, advanced_search, simple_search, help_text, display_as_dropdown, tooltip_text, regexp_filter, hide_when_uploading, hide_when_restricted, required, linked_data_field, automatic_nodes_ordering, display_condition, onchange_macro, field_constraint, active, sync_field)
VALUES (104, 'ttsgeneratedat', 'TTS Generated At', 0, 960, 0, 0, 1, 1, '', 'Transcription', '', '', 1, 0, 'Timestamp of TTS audio generation', 0, '', '', 0, 0, 0, '', 1, '', '', 0, 1, 0);

-- Verify creation
SELECT ref, name, title, type FROM resource_type_field WHERE ref >= 101 AND ref <= 104 ORDER BY ref;
